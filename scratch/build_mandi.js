...
const existingMandi = JSON.parse(fs.readFileSync(path.join(__dirname, '../database/mandi/mandi.json'), 'utf8'));
...
const extraMandis = [
  {
    ...
    metadata: {
      ...
      isLivePrice: false,
      keywords: ["msp", "minimum support price", "sarkari bhav", "gehun msp", "dhaan msp"],
      keywords_hi: ["एमएसपी", "सरकारी भाव", "न्यूनतम समर्थन मूल्य"],
      keywords_romanized: ["msp bhav", "sarkari rate", "minimum support price"]
    }
  },
  {
    ...
    metadata: {
      ...
      isLivePrice: false,
      keywords: ["mandi moisture", "nami katoti", "grain moisture limit", "mandi grading"],
      keywords_hi: ["नमी कटौती", "मंडी में कटौती", "दाना सुखाना"],
      keywords_romanized: ["nami katoti", "mandi moisture"]
    }
  },
  {
    ...
    metadata: {
      ...
      isLivePrice: false,
      keywords: ["mandi transport", "which mandi to sell", "mandi price comparison", "net mandi profit"],
      keywords_hi: ["मंडी भाड़ा", "कौन सी मंडी में बेचें", "मंडी मुनाफा"],
      keywords_romanized: ["mandi bhada", "konsi mandi me beche"]
    }
  },
  {
    ...
    metadata: {
      ...
      distance: "45km",
      highlightedFor: ["mustard", "chilli", "potato", "onion"],
      isLivePrice: false,
      keywords: ["azamgarh mandi", "azamgarh apmc", "mustard price azamgarh"],
      keywords_hi: ["आजमगढ़ मंडी", "सरसों भाव आजमगढ़"],
      keywords_romanized: ["azamgarh mandi", "azamgarh bhav"]
    }
  },
  {
    ...
    metadata: {
      type: "Government APMC",
      distance: "85km",
      highlightedFor: ["tomato", "green chilli", "paddy"],
      isLivePrice: false,
      keywords: ["varanasi mandi", "pindra mandi", "tomato varanasi price"],
      keywords_hi: ["वाराणसी मंडी", "टमाटर भाव बनारस"],
      keywords_romanized: ["varanasi mandi", "banaras mandi bhav"]
    }
  },
  {
    ...
    metadata: {
      type: "Government APMC",
      distance: "160km",
      highlightedFor: ["wheat", "gram", "mustard", "soybean"],
      isLivePrice: false,
      keywords: ["kanpur mandi", "kanpur galla mandi", "wheat kanpur price"],
      keywords_hi: ["कानपुर मंडी", "गल्ला मंडी कानपुर"],
      keywords_romanized: ["kanpur mandi", "kanpur bhav"]
    }
  },
  {
    ...
    metadata: {
      ...
      isLivePrice: false,
      keywords: ["mandi policy", "offline mandi price", "live vs cached mandi"],
      keywords_hi: ["मंडी भाव पॉलिसी", "ऑफलाइन भाव"],
      keywords_romanized: ["offline mandi bhav", "live mandi price"]
    }
  }
];

extraMandis.forEach(m => {
  existingMandi.push(m);
});

console.log("Total mandi records generated:", existingMandi.length);
fs.writeFileSync(path.join(__dirname, '../database/mandi/mandi.json'), JSON.stringify(existingMandi, null, 2));
console.log("Successfully written to database/mandi/mandi.json");
