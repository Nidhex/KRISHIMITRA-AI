...
// Preserve existing 8 schemes and expand to 20
const existingSchemes = JSON.parse(fs.readFileSync(path.join(__dirname, '../database/schemes/schemes.json'), 'utf8'));
...
const newSchemes = [
  {
    ...
    metadata: {
      ...
      eligibilityRules: { allowedStates: ["All"], requiredOwnership: ["Owner", "Tenant", "Sharecropper"] },
      documents: ["Aadhaar Card", "Land record (Khasra/Jamabandi)", "Bank Passbook", "Passport Photo"],
      keywords: ["kcc", "kisan credit card", "crop loan", "kisan loan", "4 percent interest loan"],
      keywords_hi: ["किसान क्रेडिट कार्ड", "केसीसी", "फसल ऋण", "किसान लोन"],
      keywords_romanized: ["kcc loan", "kisan credit card", "kcc kaise banwaye"]
    }
  },
  {
    ...
    metadata: {
      ...
      eligibilityRules: { allowedStates: ["All"], requiredOwnership: ["Owner", "Tenant", "Sharecropper"] },
      documents: ["Aadhaar Card", "Bank Account Details", "Mandi Gate Pass / Lot details"],
      keywords: ["enam", "e-nam", "online mandi", "mandi online sell", "national agriculture market"],
      keywords_hi: ["ई नाम", "ऑनलाइन मंडी", "फसल ऑनलाइन बेचना"],
      keywords_romanized: ["enam portal", "online mandi sell", "enam kisan"]
    }
  },
  {
    ...
    metadata: {
      ...
      eligibilityRules: { allowedStates: ["All"], requiredOwnership: ["Owner", "FPO", "Agri Entrepreneur"] },
      documents: ["DPR (Detailed Project Report)", "Aadhaar Card", "Land papers", "Bank Account details"],
      keywords: ["aif", "agri infra fund", "cold storage subsidy", "warehouse loan"],
      keywords_hi: ["कृषि इंफ्रा फंड", "कोल्ड स्टोरेज ऋण", "गोदाम सब्सिडी"],
      keywords_romanized: ["agri infra fund", "cold storage subsidy"]
    }
  },
  {
    ...
    metadata: {
      ...
      eligibilityRules: { allowedStates: ["All"], requiredOwnership: ["Owner", "Leased Land"] },
      documents: ["Aadhaar Card", "Land record or Pond Lease agreement", "Bank Passbook"],
      keywords: ["pmmsy", "matsya sampada", "fish farming subsidy", "machhli palan subsidy"],
      keywords_hi: ["मत्स्य संपदा", "मछली पालन सब्सिडी", "तालाब योजना"],
      keywords_romanized: ["machhli palan subsidy", "matsya sampada"]
    }
  },
  {
    ...
    metadata: {
      ...
      eligibilityRules: { allowedStates: ["All"], requiredOwnership: ["Owner", "Leased Land"] },
      documents: ["Aadhaar Card", "Project Report", "Land Proof", "Bank Loan Sanction letter"],
      keywords: ["nlm", "livestock mission", "bakri palan subsidy", "poultry farm subsidy"],
      keywords_hi: ["पशुधन मिशन", "बकरी पालन लोन", "मुर्गी पालन सब्सिडी"],
      keywords_romanized: ["bakri palan subsidy", "poultry farm subsidy"]
    }
  },
  {
    ...
    metadata: {
      ...
      eligibilityRules: { allowedStates: ["All"], requiredOwnership: ["Individual", "SHG", "FPO"] },
      documents: ["Aadhaar Card", "Udyam Registration", "Bank Account Details", "Quotation for Machinery"],
      keywords: ["pmfme", "food processing subsidy", "flour mill subsidy", "oil mill loan"],
      keywords_hi: ["खाद्य प्रसंस्करण सब्सिडी", "आटा चक्की लोन", "तेल कोल्हू सब्सिडी"],
      keywords_romanized: ["pmfme scheme", "food processing subsidy"]
    }
  },
  {
    ...
    metadata: {
      ...
      eligibilityRules: { allowedStates: ["All"], requiredOwnership: ["Startup", "Farmer Innovator"] },
      documents: ["Aadhaar Card", "Startup Pitch Deck / Project Proposal", "Bank Account"],
      keywords: ["rkvy", "raftaar", "agri startup grant", "krishi vikas yojana"],
      keywords_hi: ["राष्ट्रीय कृषि विकास योजना", "कृषि स्टार्टअप अनुदान"],
      keywords_romanized: ["rkvy raftaar", "agri startup grant"]
    }
  },
  {
    ...
    metadata: {
      ...
      eligibilityRules: { allowedStates: ["All"], requiredOwnership: ["Owner", "Tenant"] },
      documents: ["Aadhaar Card", "Land Jamabandi details"],
      keywords: ["seed village scheme", "certified seed subsidy", "beej anudan", "smsp"],
      keywords_hi: ["बीज सब्सिडी", "उन्नत बीज अनुदान", "बीज ग्राम योजना"],
      keywords_romanized: ["beej anudan", "seed subsidy scheme"]
    }
  },
  {
    ...
    metadata: {
      ...
      keywords: ["natural farming", "prakritik krishi", "jeevamrit", "bpkp", "zero budget farming"],
      keywords_hi: ["प्राकृतिक खेती", "जीवामृत", "प्राकृतिक कृषि योजना"],
      keywords_romanized: ["prakritik krishi", "jeevamrit scheme"]
    }
  },
  {
    ...
    metadata: {
      ...
      eligibilityRules: { allowedStates: ["All"], requiredOwnership: ["Owner"] },
      documents: ["Aadhaar Card", "Land records (RoR)", "Bank Details"],
      keywords: ["bamboo mission", "baans ki kheti subsidy", "nbm scheme"],
      keywords_hi: ["बांस मिशन", "बांस की खेती सब्सिडी"],
      keywords_romanized: ["bamboo mission", "baans subsidy"]
    }
  },
  {
    ...
    metadata: {
      ...
      eligibilityRules: { allowedStates: ["All"], requiredOwnership: ["Owner", "Landless"] },
      documents: ["Aadhaar Card", "Training Certificate (NBB recognized)", "Bank Passbook"],
      keywords: ["beekeeping subsidy", "madhumakkhi palan", "honey mission", "nbhm"],
      keywords_hi: ["मधुमक्खी पालन", "शहद मिशन", "बी बॉक्स सब्सिडी"],
      keywords_romanized: ["madhumakkhi palan", "honey mission subsidy"]
    }
  },
  {
    ...
    metadata: {
      ...
      eligibilityRules: { allowedStates: ["All"], requiredOwnership: ["Owner", "Community"] },
      documents: ["Aadhaar Card", "Land Khasra Record"],
      keywords: ["pmksy", "krishi sinchayee yojana", "har khet ko pani", "check dam scheme"],
      keywords_hi: ["कृषि सिंचाई योजना", "हर खेत को पानी", "तालाब योजना"],
      keywords_romanized: ["pmksy scheme", "krishi sinchayee yojana"]
    }
  }
];

newSchemes.forEach(s => {
  existingSchemes.push(s);
});

console.log("Total scheme records generated:", existingSchemes.length);
fs.writeFileSync(path.join(__dirname, '../database/schemes/schemes.json'), JSON.stringify(existingSchemes, null, 2));
console.log("Successfully written to database/schemes/schemes.json");
